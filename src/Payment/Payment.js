...
const Payment = () => {
	...
	const doPayment = async () => {
		...
		try {
			const res = await axios.post('http://localhost:8080/payments', paymentdone);
		...
		<div>
			...
			<div className="container">
				<div className="row">
								...
								<div className="collapse show p-3 pt-0" id="collapseExample">
									<div className="row">
										<div className="col-lg-5 mb-lg-0 mb-3">
											...
											<p className="mb-0">
												<span className="fw-bold">Price:</span>
												<span className="c-green"> Rs {price}</span>
											</p>
											<p className="mb-0">
												Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque
												nihil neque quisquam aut repellendus, dicta vero? Animi dicta
					...
					<div className="col-12">
						<Link to="/summary" onClick={doPayment} state={{ order_id: order_id }}>
